...
public class MySQLAccess {
        ...
        public ResultSet getInsideWorkoutOnID(int trening_ID) throws Exception {
        	try {
                String queryString = "SELECT trening.trening_ID, idrett.idrett_ID, idrett.navn AS idrett, 'Innetrening' AS inneUte, ovelse.navn AS ovelse, ";
        ...
        public ResultSet getOutsideWorkoutOnID(int trening_ID) throws Exception {
        	try {
                String queryString = "SELECT trening.trening_ID, idrett.idrett_ID, idrett.navn AS idrett, 'utetrening' AS inneUte, ovelse.navn AS ovelse, ";
